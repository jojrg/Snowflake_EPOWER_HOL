...
- Houses with **solar panels on rooftops** and **battery storage units** in garages (labeled "ePulse VPP")
- An **ePulse gateway device** (small IoT box) on one house, sending data signals (dotted lines) toward the Snowflake hub
...
Mid-right: A **retail store / Smart Home Shop** with:
- Products on display: solar panels, batteries, heat pumps, wallboxes, smart thermostats
- Customers browsing, a consultant showing a product
- Price tags and energy labels
...
- A **demo script clipboard** labeled "demo_flow.md — 12 Questions, 4 Acts" held by a presenter character
...
- "Deep Insights & Task-Oriented Outcomes" (near the agent)
- "Virtual Power Plant", "Semantic Views", "Cortex Search", "dbt Pipelines", "MCP Server"
- "9 Search Services", "7 Semantic Views", "12 MCP Tools"
